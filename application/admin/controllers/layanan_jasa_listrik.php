...
class layanan_jasa_listrik extends My_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('mdl_layanan_jasa_listrik', 'layanan_jasa');
	...
	function index()
	{
		...
		$this->load->view('layanan_jasa_listrik/layanan_jasa_listrik_list', $data);
	...
	function update($id)
	{
		...
		$this->load->view('layanan_jasa_listrik/layanan_jasa_listrik_edit', $data);
