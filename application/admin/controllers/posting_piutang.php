...
class posting_piutang extends My_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('mdl_piutang', 'piutang');		$this->load->model('mdl_posting_masuk', 'posting_masuk');		$this->load->library(array('fungsi','pquery'));
	...
	function index()
	{
		...
		$data['results'] = $this->piutang->getItem_posting();		$data_posting = $this->piutang->getItem_posting();		//$count_data_posting = $this->piutang->count_getItem();		
