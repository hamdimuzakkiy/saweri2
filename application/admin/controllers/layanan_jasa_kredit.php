...
class layanan_jasa_kredit extends My_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('mdl_layanan_jasa_kredit', 'layanan_jasa');
	...
	function index()
	{
		...
		$this->load->view('layanan_jasa_kredit/layanan_jasa_kredit_list', $data);
	...
	function update($id)
	{
		...
		$this->load->view('layanan_jasa_kredit/layanan_jasa_kredit_edit', $data);
