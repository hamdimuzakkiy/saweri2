...
class layanan_jasa_telepon extends My_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('mdl_layanan_jasa_telepon', 'layanan_jasa');
	...
	function index()
	{
		...
		$this->load->view('layanan_jasa_telepon/layanan_jasa_telepon_list', $data);
	...
	function update($id)
	{
		...
		$this->load->view('layanan_jasa_telepon/layanan_jasa_telepon_edit', $data);
