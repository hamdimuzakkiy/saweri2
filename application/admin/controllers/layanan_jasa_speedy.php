...
class layanan_jasa_speedy extends My_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('mdl_layanan_jasa_speedy', 'layanan_jasa');
	...
	function index()
	{
		...
		$this->load->view('layanan_jasa_speedy/layanan_jasa_speedy_list', $data);
	...
	function update($id)
	{
		...
		$this->load->view('layanan_jasa_speedy/layanan_jasa_speedy_edit', $data);
