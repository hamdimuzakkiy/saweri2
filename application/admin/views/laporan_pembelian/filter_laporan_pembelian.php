...
<script type="text/javascript">
	...
	function laporan(pageURL, title,w,h){
		...
		if ((periode_awal=='')||(periode_akhir=='')){
			...
			var targetWin = window.open ('<?=site_url();?>/laporan_pembelian/show_report/'+periode_awal+'/'+periode_akhir, title, 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width='+w+', height='+h+', top='+top+', left='+left);
