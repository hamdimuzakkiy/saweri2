...
<script type="text/javascript">
	...
	function report_pdf(){	
			...
			myForm.action = "<?=site_url();?>/laporan_pembelian/pdf_lap_retur_pembelian/";
...
<?php
			...
			echo form_open('laporan_pembelian/view_lap_retur_pembelian/v_excel', $attributes);
?>
...
<div id="div_laporan">
	<table class="laporan" width="90%" border="1">
		...
		<tr>
			...
			<th scope="col">REF RETUR PEMBELIAN</th>
			<th scope="col">PO</th>
		...
		?>
				<tr>
					...
					<td align="right" valign="middle"><?=$row->id_retur_pembelian?></td>
		...
		<tr><td colspan="7"><b>Jumlah Keseluruhan : </b></td><td align="right"><b><?php if(isset($row->qty)){ echo  array_sum($sum_total);} ?></b></td></tr>
