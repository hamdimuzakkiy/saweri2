<script type="text/javascript">
	...
	function batal(){
		document.location.href = '<?=base_url().'index.php/layanan_jasa_speedy'?>';
	}
...
<section class="grid_12">
	<div class="block-border">
		<?php
			...
			echo form_open('layanan_jasa_speedy/process_update', $attributes);
		?>
			<h1>Layanan > Edit Data Layanan Jasa Speedy</h1>
			
			<fieldset class="grey-bg margin">
				
				<div class="columns">						
					<p class="colx2-left">
						<label for="complex-en-url">Periode Pembayaran Speedy (*) :</label>
				...
				<div class="columns">
					<p class="colx3-left">
						<label for="complex-en-url">No Rekening Pelanggan Speedy (*) :</label>
						<span class="relative">
							<? 
			...
			<fieldset class="grey-bg no-margin">
			 <legend> Info Rekening </legend>
				<div class="columns">
					<p class="colx3-left">
						<label for="complex-en-url">Tanggal Pembayaran Speedy (*) :</label>
						<span class="relative">
							<? 
