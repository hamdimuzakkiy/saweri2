<script type="text/javascript">
	...
	function set_barang(id, nama, harga, idjenis){
		document.getElementById('detail_idbarang').value = id;	
		document.getElementById('detail_namabarang').value = nama;				document.getElementById('detail_idjenis').value = idjenis;
...
<table width="666" border="1" align="center" cellpadding="1" cellspacing="1">
	...
	?>
			<tr>
				<td align="left" valign="middle"><a href="javascript:set_barang('<?=$row->id_barang?>', '<?=$row->nama_barang?>', 0,<?=$row->id_jenis?>)"><?=$row->nama_barang?></a></td>
