...
<script type="text/javascript">
	...
	function set_detail(){
		$.ajax({
			type: 'POST',
			url: '<?=base_url().'asset/admin/js/ajax_ro.php?command=add_1'?>', //url: $(this).attr('action'),
...
<section class="grid_12">
	<div class="block-border">
		<?php
			...
			echo form_open('request_order/insert', $attributes);
		?>
			<h1>Pembelian > Tambah Data Request Order </h1>
			
			<fieldset>
				
				
				<div class="columns">
					<input type="hidden" name="id_request_order" id="id_request_order" value="<?=date('YmdHis')?>">
					<p class="colx3-left">
