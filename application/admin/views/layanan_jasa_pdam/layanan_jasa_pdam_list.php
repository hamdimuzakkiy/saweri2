<section class="grid_12">
	<div class="block-border">
		<form class="block-content form" id="table_form" method="post" action="">
			<h1>Layanan > Data Layanan Jasa PDAM</h1>
			...
			<div class="block-controls">
				...
				<ul class="controls-buttons">
					...
					<li><?
							if ($can_insert == TRUE){
								echo anchor('layanan_jasa_pdam/insert', 'Tambah Data');
							}
						?></li>
				</ul>
				...
				<tbody>
					...
					<tr>
						...
						<td align="left" valign="top" class="table-actions">
							<?php
								if ($can_update == TRUE){
									echo anchor('layanan_jasa_pdam/update/'.$row->id_layanan_jasa, '<img src="'.base_url().'asset/admin/images/icons/fugue/pencil.png" width="16" height="16">', array('class'=>'with-tip', 'title'=>'Edit'));
								}
								
								if ($can_delete == TRUE){
									echo anchor('layanan_jasa_pdam/delete/'.$row->id_layanan_jasa, '<img src="'.base_url().'asset/admin/images/icons/fugue/cross-circle.png" width="16" height="16">', array('class'=>'with-tip', 'title'=>'Edit', 'onclick'=>"return confirm('Anda yakin akan menghapus data ini?')"));
								}
							?>
						</td>
					</tr>
			...
			<div class="block-footer">
				...
				<span class="sep"></span>
				<?=anchor('layanan_jasa_pdam/insert', 'Tambah Data', array('class'=>'button'))?>
				<span class="sep"></span>
