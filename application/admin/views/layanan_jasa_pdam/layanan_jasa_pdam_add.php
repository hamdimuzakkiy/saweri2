<script type="text/javascript">
	...
	function batal(){
		document.location.href = '<?=base_url().'index.php/layanan_jasa_pdam'?>';
	}
...
<section class="grid_12">
	<div class="block-border">
		<?php
			...
			echo form_open('layanan_jasa_pdam/insert', $attributes);
		?>
			<h1>Layanan > Tambah Data Layanan Jasa PDAM</h1>
			
			<fieldset class="grey-bg margin">
				<div class="columns">
					<p class="colx2-left">
						<label for="complex-en-url">Periode Pembayaran PDAM (*)  :</label>
						<span class="relative">
			...
			<legend> Info Pelanggan </legend>
				<div class="columns">
					<p class="colx3-left">
						<label for="complex-en-url">No Rekening Pelanggan PDAM (*) :</label>
						<span class="relative">
			...
			<legend> Info Rekening </legend>
				<div class="columns">
					<p class="colx3-left">
						<label for="complex-en-url">Tanggal Pembayaran PDAM (*) :</label>
						<span class="relative">
				...
				<div class="columns">
					<p class="colx3-left">
						...
						<span class="relative">
							<input type="text" name="total_bayar" id="total_bayar" value="<?=set_value('total_bayar')?>" class="duapertiga-width" readonly="true">
						</span>
					</p>
					<!--<p class="colx3-center">
