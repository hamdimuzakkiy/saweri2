<script type="text/javascript">
	...
	function batal(){
		document.location.href = '<?=base_url().'index.php/layanan_jasa_listrik'?>';
	}
...
<section class="grid_12">
	<div class="block-border">
		<?php
			...
			echo form_open('layanan_jasa_listrik/process_update', $attributes);
		?>
			<h1>Layanan > Edit Data Layanan Jasa Listrik</h1>
			
			<fieldset class="grey-bg margin">
				
				<div class="columns">						
					<p class="colx2-left">
						<label for="complex-en-url">Periode Pembayaran Listrik (*) :</label>
				...
				<div class="columns">
					<p class="colx3-left">
						<label for="complex-en-url">No Rekening Pelanggan Listrik (*) :</label>
						<span class="relative">
							<? 
			...
			<fieldset class="grey-bg no-margin">
			 <legend> Info Rekening </legend>
				<div class="columns">
					<p class="colx3-left">
						<label for="complex-en-url">Tanggal Pembayaran Listrik (*) :</label>
						<span class="relative">
							<? 
					...
					<p class="colx3-left">
						...
						<span class="relative">
							<? 
								...
								{
									echo '<input type="text" name="total_bayar" id="total_bayar" value="'.set_value('total_bayar').'" class="duapertiga-width" oreadonly="true" >';
								}else
								{
