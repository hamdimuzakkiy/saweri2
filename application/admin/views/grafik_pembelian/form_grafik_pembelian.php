<script type="text/javascript">
	...
	function laporan(pageURL, title,w,h){
		...
		if ((periode_awal=='')||(periode_akhir=='')){
			...
			// change form info:
			myForm.target = title;
			myForm.action = "<?=site_url();?>/grafik_pembelian/view_grafik_pembelian/" + periode_awal + "/" + periode_akhir;
...
<section class="grid_12">
	<div class="block-border">
		<?php
			...
			echo form_open('grafik_pembelian/view_grafik_pembelian', $attributes);
		?>
			<h1>Form Grafik Pembelian</h1>
