		...
		<form class="block-content form"  name="table_form" id="table_form" method="post" action="">
			...
			<div class="block-controls">
				...
				<ul class="controls-buttons">
					...
					<li><?
							if ($can_insert == TRUE){
								echo anchor('harga_jual/insert', 'Tambah Data');
							}
						?></li>
				</ul>
			...
			<div class="no-margin"><table class="table" cellspacing="0" width="100%">
				...
				<thead>
					<tr>
						...
						<th align="left" valign="top" scope="col">Harga Jual</th>
				...
				<tbody>
					...
					<tr>
						...
						<td align="left" valign="top"><?=convert_rupiah($row->harga_jual)?> </td>
						<td align="left" valign="top" class="table-actions">
							<?php
								if ($can_update == TRUE){
									echo anchor('harga_jual/update/'.$row->id_harga, '<img src="'.base_url().'asset/admin/images/icons/fugue/pencil.png" width="16" height="16">', array('class'=>'with-tip', 'title'=>'Edit'));
								}
								
								if ($can_delete == TRUE){
									echo anchor('harga_jual/delete/'.$row->id_harga, '<img src="'.base_url().'asset/admin/images/icons/fugue/cross-circle.png" width="16" height="16">', array('class'=>'with-tip', 'title'=>'Edit', 'onclick'=>"return confirm('Anda yakin akan menghapus data ini?')"));
								}
							?>
						</td>
					</tr>
			...
			<div class="block-footer">
				...
				<span class="sep"></span>
				<?=anchor('harga_jual/insert', 'Tambah Data', array('class'=>'button'))?>
				<span class="sep"></span>
