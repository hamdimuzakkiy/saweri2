...
<section class="grid_12">
	<div class="block-border">
		<?php
			...
			echo form_open('harga_jual/insert', $attributes);
		?>
			<h1>Tambah Data Harga Jual</h1>
			
			<fieldset class="grey-bg margin">
				<div class="columns">
					<p class="colx2-left">
						<label for="complex-en-url">Periode Harga Jual (*) :</label>
						<span class="relative">
				...
				<div class="columns">
					...
					<p class="colx3-center">
						...
						<span class="relative">
							<input type="text" name="harga_jual" id="harga_jual" value="<?=set_value('harga_jual')?>" class="duapertiga-width">
						</span>
					</p>
					</div>
