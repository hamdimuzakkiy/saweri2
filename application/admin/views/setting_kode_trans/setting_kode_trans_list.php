...
if ($can_update == TRUE){
	...
	/*if ($can_delete == TRUE){
	echo anchor('setting_kode_trans/delete/'.$row->id, 
	'<img src="'.base_url().'asset/admin/images/icons/fugue/cross-circle.png" width="16" height="16">', 
	array('class'=>'with-tip', 'title'=>'Edit', 'onclick'=>"return confirm('Anda yakin akan menghapus data ini?')"));
	}*/
	?>
	</td>
	</tr>
