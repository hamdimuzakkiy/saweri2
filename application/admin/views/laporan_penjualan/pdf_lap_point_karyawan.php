...
<div id="div_laporan" align="center">
	<table class="laporan" width="90%">
		...
		<tr><td colspan="8" div align="center"><b>LAPORAN POINT KARYAWAN</b></td></tr>
		<tr><td align="left" colspan="8"><b>TANGGAL CETAK : <?php echo date('d '. ' M' . ' Y') ?></b></td></tr>
		<tr>
			<th class="th_border" scope="col">NO3</th>
			<th class="th_border" scope="col">KODE KARYAWAN</th>
		...
		?>
				...
				<tr class="border">
					...
					<td class="use_border" align="center" valign="middle"><?=$row->kode_karyawan?></td>
					...
					<td class="use_border" align="left" valign="middle"><?=$row->telpon?></td>
		...
		?>
		<tr class="border"><td colspan="6" align="left" class="use_border"><b>Jumlah Keseluruhan: </b></td><td align="right" class="use_border"><b><?php if(isset($row->point)){ echo  array_sum($sum_total);} ?></b></td></tr>
