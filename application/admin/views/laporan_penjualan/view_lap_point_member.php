...
<script type="text/javascript">
	...
	function report_pdf(){		      
		...
		myForm.action = "<?=site_url();?>/laporan_penjualan/pdf_lap_point_member";
...
<?php
	...
	echo form_open('laporan_penjualan/view_lap_point_member/v_excel', $attributes);
...
<div id="div_laporan">
	...
	<?php
		$i=0;
		foreach ($kode_pelanggan as $nama){
	...
	<table class="laporan" width="90%" border="1">
		...
		<tr><td colspan="8" div align="center"><b>LAPORAN POINT PELANGGAN</b></td></tr>
		<tr><td colspan="8"><b>PERIODE : <?php // echo $this->fungsi->dateindo3('-',$periode_awal) . ' S/D ' .  $this->fungsi->dateindo3('-',$periode_akhir); ?></b></td></tr>
		<tr><td colspan="8"><b>TANGGAL CETAK : <?php echo $this->fungsi->dateindo3('-',date('Y-m-d')) ?></b></td></tr>
		<tr>
			<th scope="col">NO</th>
		...
		?>
				<tr>
					...
					<td align="left" valign="middle"><?=$row->kode_pelanggan?></td>
					<td align="left" valign="middle"><?=$row->nama?></td>
					<td align="left" valign="middle"><?=$row->nama_cabang?></td>
					<td align="left" valign="middle"><?=$row->nama_area?></td>
					<td align="left" valign="middle"><?=$row->alamat?></td>
					<td align="left" valign="middle"><?=$row->tel?></td>
		...
		?>
			<tr>
				<td colspan="7"><b>JUMLAH : </b></td><td align="right"><b><?php if (isset($row->point)){ echo array_sum($sum_total); } ?></b></td>
			</tr>
	</table>
</div>
</form>