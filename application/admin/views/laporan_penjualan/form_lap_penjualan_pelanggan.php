...
<script type="text/javascript">
	...
	$(document).ready(function() {
		//$("#getbarang").fancybox();
            ...
            $.ajax({
                url: site+"/laporan_penjualan/get_pelanggan/",
            ...
            queryDelay: 200,
            innerText: "pencarian nama pelanggan",
	...
	function laporan(title, w, h){
		...
		if ((periode_awal=='')||(periode_akhir=='')){
			...
			// change form info:
			myForm.target = title;
			myForm.action = "<?=site_url();?>/laporan_penjualan/view_lap_penjualan_pelanggan/v_html";
...
<section class="grid_12">
	<div class="block-border">
		<?php
			...
			echo form_open('laporan_penjualan/view_lap_area/v_', $attributes);
		?>
			<h1>Form Laporan Penjualan [Pelanggan]</h1>
