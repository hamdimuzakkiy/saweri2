...
<section class="grid_12">
	<div class="block-border">
		<form class="block-content form" name="table_form" id="table_form" method="post" action="">
			<h1>Penjualan > Data Penukaran Point</h1>
				...
				<ul class="controls-buttons">
					...
					<li><?
							if ($can_insert == TRUE){
								echo anchor('penukaran_point/insert', 'Tambah Data');
							}
						?></li>
				</ul>
			...
			<div class="no-margin"><table class="table" cellspacing="0" width="100%">
				...
				<thead>
					<tr>
						...
						<th align="left" valign="top" scope="col">Point Barang</th>
						<th align="left" valign="top" scope="col">Qty Penukaran</th>
						<th align="left" valign="top" scope="col">Sisa Point</th>
				...
				<tbody>
					...
					<tr>
						<!--<td align="left" valign="top"><input name="id[]" id="id" value="<?=$row->id_penukaran_point?>" type="checkbox" /></td>-->
						...
						<td align="left" valign="top"><?=$row->point_pelanggan?> </td>
						<td align="left" valign="top" class="table-actions">
							<?php								
								if ($can_delete == TRUE){
									 echo anchor('penukaran_point/delete/'.$row->id_penukaranpoint, '<img src="'.base_url().'asset/admin/images/icons/fugue/cross-circle.png" width="16" height="16">', array('class'=>'with-tip', 'title'=>'Edit', 'onclick'=>"return confirm('Anda yakin akan menghapus data ini?')"));
								}
							?>
						</td>
					</tr>
			...
			<div class="block-footer">
				...
				<span class="sep"></span>
				<?=anchor('penukaran_point/insert', 'Tambah Data', array('class'=>'button'))?>
				<span class="sep"></span>
