...
<section class="grid_12">
	<div class="block-border">
		<?php
			...
			echo form_open('harga_beli/process_update', $attributes);
		?>
			<h1>Edit Data Harga Beli</h1>
			...
			<fieldset>
				<div class="columns">						
					...
					<p class="colx3-center">
						...
						<span class="relative">
							<? 
								if (form_error('harga_beli') != null)
								{
									echo '<input type="text" name="harga_beli" id="harga_beli" value="'.set_value('harga_beli').'" class="duapertiga-width">';
								}else
								{
									echo '<input type="text" name="harga_beli" id="harga_beli" value="'.$harga_beli.'" class="duapertiga-width">';
								}
							?>
						</span>
					</p>
