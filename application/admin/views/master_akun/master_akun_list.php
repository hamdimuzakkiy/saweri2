		...
		<form class="block-content form" name="table_form" id="table_form" method="post" action="">
			...
			<div class="block-controls">
				...
				<ul class="controls-buttons">
					...
					<li><?
							if ($can_insert == TRUE){
								echo anchor('master_akun/insert', 'Tambah Data');
							}
						?>
					</li>
				</ul>
				...
				<tbody>
					...
					<tr>
						...
						<td align="left" valign="top" class="table-actions">
							<?php	
								if ($can_update == TRUE){
									echo anchor('master_akun/update/'.$row->AKUNID, '<img src="'.base_url().'asset/admin/images/icons/fugue/pencil.png" width="16" height="16">', array('class'=>'with-tip', 'title'=>'Edit')).'&nbsp;&nbsp;';
								}
								
								if ($can_delete == TRUE){
									echo anchor('master_akun/delete/'.$row->AKUNID, '<img src="'.base_url().'asset/admin/images/icons/fugue/cross-circle.png" width="16" height="16">', array('class'=>'with-tip', 'title'=>'Delete', 'onclick'=>"return confirm('Anda yakin akan menghapus data ini?')"));
								}
							?>
						</td>
					</tr>
			...
			<div class="block-footer">
				...
				<span class="sep"></span>
				<?php
						echo anchor('master_akun/insert', 'Tambah Data', array('class'=>'button'));
				?>
				<span class="sep"></span>
